...
async def vcraid(_, e: Message):
    ...
    aud = choice(aud_list)
    if inp:
        TheVenomXD = await e.reply_text("**ʟᴏ ᴍᴀsᴛᴇʀ ɪsᴋɪ ʙʜɪ ɢᴀɴᴅ ᴍᴀʀᴅᴇᴛᴀ sᴛᴀʀᴛɪɴɢ ᴠᴄ ʀᴀɪᴅ 👑**")
        ...
        if chat_id in QUEUE:
            ...
            await TheVenomXD.delete()
            await e.reply_text(f"**> Raid ᴋᴀʀ ʀᴀʜᴀ** {chat_.title} \n\n**> Audio:** {songname} \n**> Position:** Ongoing Raid")
...
async def ping(_, e: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            clear_queue(chat_id)
            await e.reply_text("**ᴠᴄ ʀᴀɪᴅ ᴋʜᴀᴛᴀᴍ ɢᴀɴᴅ ᴘʜᴀᴛ ɢʏɪ ᴏᴘᴘᴏɴᴇɴᴛ ᴋɪ**")
        except Exception as ex:
            await e.reply_text(f"**ERROR ᴀᴀɢʏᴀ ʙᴄ** \n`{ex}`")
    else:
        await e.reply_text("**ᴋᴏɪ ʀᴀɪᴅ ɴᴀ ᴄʜʟʀᴀ**")
...
async def ping(_, e: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await e.reply_text(f"**ᴛʜᴏᴅɪ ᴅᴇʀ ᴋᴇ ʟɪʏᴇ ʙᴀᴄʜ ɢʏᴀ ᴋɪᴍᴅ:** {chat_.title}")
...
async def ping(_, e: Message):
    ...
    if chat_id in QUEUE:
        try:
            ...
            await e.reply_text(f"**ᴄʜᴜᴅᴀɪ ᴋɪ ᴍᴀᴄʜɪɴᴇ sᴛᴀʀᴛ {chat_.title}**")
        except Exception as e:
            await e.reply_text(f"**ERROR ᴀᴀɢʏᴀ ʙᴄ** \n`{e}`")
    else:
        await e.reply_text("**ᴋᴏɪ ʀᴀɪᴅ ᴘᴀᴜsᴇ ɴᴀ ʜᴀɪ!**")
